...
<li class="task-list-item"><input type="checkbox" id="" disabled="" class="task-list-item-checkbox" checked=""> Create an input page to enter input (postcode and house number) and make a request. </li>
...
The color palette of Dunkin' is used in the project.
 ...
 ## App Demo
 <img src="./img/craversDemo.gif" style="width: 100%;">
